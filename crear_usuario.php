...
<body>
    <div class="register-container">
        ...
        <!-- 
            CAMBIO CLAVE:
            1. 'action' apunta a nuestro nuevo script PHP.
            2. 'method' es "POST" (más seguro para enviar datos).
            3. Quitamos el 'id' del form, ya no lo necesita el JS.
        -->
    ...
    <!-- 
        Quitamos el script de JS que guardaba en localStorage,
        porque ahora el PHP se encarga de todo.
        Las validaciones 'pattern' del HTML siguen funcionando.
    -->
</body>
</html>